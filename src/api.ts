...
import { delete_post, get_latest_posts, get_popular_posts, get_post, get_post_response, get_posts, get_user_response, update_like_post, update_view_post } from "./state/response_constant";
import { get_posts_request, post_signin, post_signup } from "./state/request_constant";
...
// get post
export const getPost = (postId: string) => API.get<get_post_response>(api_constant.getPost(postId)).then(res => res.data)
